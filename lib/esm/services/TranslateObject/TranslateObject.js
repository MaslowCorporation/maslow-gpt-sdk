 ...
 * @returns
 */
export default async function TranslateObject({ model_chosen, obj, language, apiKey, retries = 10, progressIntervalMs = 1000, onJobCreated, onSuccess, onError, onProgress, print = false, jobId, }) {
    try {
