 ...
 * @returns
 */
export default async function GetChatGPTArt({ model_chosen, prompt, apiKey, img_width, img_height, progressIntervalMs = 1000, onJobCreated, onSuccess, onError, onProgress, print = false, jobId, }) {
    try {
        ...
        const response = await axios.post(`${Constants.api_base_url_tailscale}/get_gpt_art?apiKey=${apiKey}`, { model_chosen, prompt, img_width, img_height });
