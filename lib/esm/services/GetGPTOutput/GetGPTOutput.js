 ...
 * @returns
 */
export default async function GetGPTOutput({ model_chosen = "gpt-3.5-turbo", prompt, apiKey, params, progressIntervalMs = 1000, onJobCreated, onSuccess, onError, onProgress, print = false, jobId, }) {
    try {
        ...
        const response = await axios.post(`${Constants.api_base_url_tailscale}/get_gpt_output?apiKey=${apiKey}`, {
            prompt,
            params,
            model_chosen,
        });
