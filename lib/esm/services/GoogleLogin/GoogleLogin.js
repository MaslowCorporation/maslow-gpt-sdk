 ...
 * @returns
 */
export default async function GoogleLogin({ apiKey, params, progressIntervalMs = 1000, onJobCreated, onSuccess, onError, onProgress, print = false, jobId, }) {
    try {
        ...
        const response = await axios.post(`${Constants.api_base_url_web}/google_login?apiKey=${apiKey}`, {
            params,
        });
