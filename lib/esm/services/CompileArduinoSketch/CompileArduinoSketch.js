 ...
 * @returns
 */
export default async function CompileArduinoSketch({ codeString, apiKey, progressIntervalMs = 1000, onJobCreated, onSuccess, onError, onProgress, print = false, jobId, }) {
    try {
        ...
        const response = await axios.post(`${Constants.api_base_url_tailscale}/compile_arduino_sketch?apiKey=${apiKey}`, { code_string: codeString });
