 ...
 * @returns
 */
export default async function DeleteFileFromCloud({ publicId, apiKey, resourceType, progressIntervalMs = 1000, onJobCreated, onSuccess, onError, onProgress, print = false, jobId, }) {
    try {
        ...
        const response = await axios.post(`${Constants.api_base_url_tailscale}/delete_file_cloud?apiKey=${apiKey}`, { publicId, resourceType });
