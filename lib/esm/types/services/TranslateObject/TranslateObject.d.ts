 ...
 * @returns
 */
export default function TranslateObject({ model_chosen, obj, language, apiKey, retries, progressIntervalMs, onJobCreated, onSuccess, onError, onProgress, print, jobId, }: {
    model_chosen?: string;
    apiKey: string;
    obj: any;
    language: string;
