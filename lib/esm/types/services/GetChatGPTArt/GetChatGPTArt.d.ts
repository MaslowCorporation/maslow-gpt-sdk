import { GetChatGPTArtStatus } from "./pieces/GetChatGPTArtStatus.js";
/**
 *
 ...
 * @returns
 */
export default function GetChatGPTArt({ model_chosen, prompt, apiKey, img_width, img_height, progressIntervalMs, onJobCreated, onSuccess, onError, onProgress, print, jobId, }: {
    model_chosen?: string;
    prompt: string;
    apiKey: string;
    img_width: number;
    ...
    onProgress?: (progress: GetChatGPTArtStatus) => void;
...
//# sourceMappingURL=GetChatGPTArt.d.ts.map