 ...
 * @returns
 */
export default function GetGPTCode({ model_chosen, prompt, apiKey, params, progressIntervalMs, onJobCreated, onSuccess, onError, onProgress, print, jobId, }: {
    model_chosen?: string;
    prompt: string;
    apiKey: string;
    params?: any;
...
//# sourceMappingURL=GetGPTCode.d.ts.map