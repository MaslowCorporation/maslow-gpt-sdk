import { TransformCloudFileStatus } from "./pieces/TransformCloudFileStatus.js";
/**
 *
 ...
 * @returns
 */
export default function TransformCloudFile({ publicId, assetType, transformations, deliveryType, version, fileExtension, apiKey, progressIntervalMs, onJobCreated, onSuccess, onError, onProgress, print, jobId, }: {
    transformations: any[];
    deliveryType: string;
    assetType: string;
    print?: boolean;
    ...
    onProgress?: (progress: TransformCloudFileStatus) => void;
...
//# sourceMappingURL=TransformCloudFile.d.ts.map