import { DeleteFileFromCloudStatus } from "./pieces/DeleteFileFromCloudStatus.js";
/**
 *
 ...
 * @returns
 */
export default function DeleteFileFromCloud({ publicId, apiKey, resourceType, progressIntervalMs, onJobCreated, onSuccess, onError, onProgress, print, jobId, }: {
    publicId: string;
    apiKey: string;
    resourceType: string;
...
//# sourceMappingURL=DeleteFileFromCloud.d.ts.map