 ...
 *
 * npm run run-service CompileArduinoSketch
 *
 * command to test this SDK method quickly and dirty ;-)
 *
 **
(async () => {
  await TestCompileArduinoSketch();
})();
*/
/**
 *
 ...
 * @returns
 */
function CompileArduinoSketch({ codeString, apiKey, progressIntervalMs = 1000, onJobCreated, onSuccess, onError, onProgress, print = false, jobId, }) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const response = yield axios_1.default.post(`${constants_js_1.Constants.api_base_url_tailscale}/compile_arduino_sketch?apiKey=${apiKey}`, { code_string: codeString });
...
exports.default = CompileArduinoSketch;
