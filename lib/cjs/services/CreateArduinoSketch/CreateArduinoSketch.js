 ...
 * @returns
 */
function CreateArduinoSketch({ model_chosen, programDescription, apiKey, progressIntervalMs = 1000, onJobCreated, onSuccess, onError, onProgress, print = false, jobId, }) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const response = yield axios_1.default.post(`${constants_js_1.Constants.api_base_url_tailscale}/create_arduino_sketch?apiKey=${apiKey}`, {
                model_chosen,
                programDescription,
            });
...
exports.default = CreateArduinoSketch;
