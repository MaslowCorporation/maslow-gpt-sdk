 ...
 * @returns
 */
function DeleteFileFromCloud({ publicId, apiKey, resourceType, progressIntervalMs = 1000, onJobCreated, onSuccess, onError, onProgress, print = false, jobId, }) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const response = yield axios_1.default.post(`${constants_js_1.Constants.api_base_url_tailscale}/delete_file_cloud?apiKey=${apiKey}`, { publicId, resourceType });
...
exports.default = DeleteFileFromCloud;
