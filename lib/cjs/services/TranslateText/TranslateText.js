 ...
 * @returns
 */
function TranslateText({ model_chosen, text, language, apiKey, progressIntervalMs = 1000, onJobCreated, onSuccess, onError, onProgress, print = false, jobId, }) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const response = yield axios_1.default.post(`${constants_js_1.Constants.api_base_url_tailscale}/translate_txt?apiKey=${apiKey}`, { model_chosen, text, language });
