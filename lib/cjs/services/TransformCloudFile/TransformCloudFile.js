 ...
 *
 * npm run run-service TransformCloudFile
 *
 * command to test this SDK method quickly and dirty ;-)
 *
 **
(async () => {
  await TestTransformCloudFile();
})();
*/
/**
 *
 ...
 * @returns
 */
function TransformCloudFile({ publicId, assetType, transformations, deliveryType = 'upload', version, fileExtension, apiKey, progressIntervalMs = 1000, onJobCreated, onSuccess, onError, onProgress, print = false, jobId, }) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const response = yield axios_1.default.post(`${constants_js_1.Constants.api_base_url_tailscale}/transform_file_cloud?apiKey=${apiKey}`, { publicId, transformations, deliveryType, assetType, version, fileExtension });
...
exports.default = TransformCloudFile;
