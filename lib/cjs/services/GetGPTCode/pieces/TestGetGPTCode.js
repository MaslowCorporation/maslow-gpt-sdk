...
exports.TestGetGPTCode = void 0;
const GetGPTCode_js_1 = __importDefault(require("../GetGPTCode.js"));
const TestGetGPTCode = () => __awaiter(void 0, void 0, void 0, function* () {
    console.log(`Some test !`);
    return (0, GetGPTCode_js_1.default)({
        model_chosen: "gpt-4",
...
exports.TestGetGPTCode = TestGetGPTCode;
