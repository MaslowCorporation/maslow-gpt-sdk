 ...
 * @returns
 */
function CheckBackgroundWork({ print, progressIntervalMs, apiKey, onSuccess, onError, onProgress, jobId }) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if ((latestJobStatus === null || latestJobStatus === void 0 ? void 0 : latestJobStatus.state) == "completed") {
            const answer = latestJobStatus === null || latestJobStatus === void 0 ? void 0 : latestJobStatus.returnvalue;
