...
*/
function UpdateWorkData({ jobId, onSuccess, onError, apiKey, print = true, params, }) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        try {
            print && console.log("Let's get the background job status for " + jobId);
            const response = yield axios_1.default.post(`${constants_js_1.Constants.api_base_url_tailscale}/update_work_data/${jobId}?apiKey=${apiKey}`, params);
...
exports.default = UpdateWorkData;
