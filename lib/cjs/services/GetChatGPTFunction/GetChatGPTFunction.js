 ...
 * @returns
 */
function GetChatGPTFunction({ model_chosen, functionName, functionLanguage, functionPurpose, functionArgs, functionReturnValue, apiKey, progressIntervalMs = 1000, onJobCreated, onSuccess, onError, onProgress, print = false, jobId, }) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const response = yield axios_1.default.post(`${constants_js_1.Constants.api_base_url_tailscale}/get_gpt_func?apiKey=${apiKey}`, {
                model_chosen,
                functionName,
                functionLanguage,
                functionPurpose,
...
exports.default = GetChatGPTFunction;
