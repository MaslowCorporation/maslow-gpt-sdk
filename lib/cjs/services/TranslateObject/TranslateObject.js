...
const GetGPTCode_js_1 = __importDefault(require("../GetGPTCode/GetGPTCode.js"));
const TryParse_js_1 = require("../TryParse/TryParse.js");
/**
 *
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (Object.keys(obj).length > 15) {
                ...
                while (keys.length > 0) {
                    subObjects.push(keys.splice(0, 15).reduce((acc, key) => {
                        acc[key] = obj[key];
                        return acc;
                    }, {}));
                }
            ...
            for (const individualSubObject of subObjects) {
                ...
                while (retryCount <= retries) {
                    ...
                    if (translatedObjDataRaw !== null && (0, TryParse_js_1.TryParse)(translatedObjDataRaw.answer.codePart)) {
            ...
            const totalCost = translatedObjectsRaw.reduce((acc, translatedObjDataRaw) => {
