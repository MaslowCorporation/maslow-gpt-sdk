import { UploadFileToCloudStatus } from "./pieces/UploadFileToCloudStatus.js";
/**
 *
 ...
 * @returns
 */
export default function UploadFileToCloud({ fileData, resourceType, apiKey, progressIntervalMs, onJobCreated, onSuccess, onError, onProgress, print, jobId, }: {
    resourceType: string;
    fileData: Blob | any;
    apiKey: string;
    progressIntervalMs: number;
    onProgress?: (progress: UploadFileToCloudStatus) => void;
...
//# sourceMappingURL=UploadFileToCloud.d.ts.map