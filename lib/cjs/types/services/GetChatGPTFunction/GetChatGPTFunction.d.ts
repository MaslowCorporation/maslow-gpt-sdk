import { GetChatGPTFunctionStatus } from "./pieces/GetChatGPTFunctionStatus.js";
/**
 *
 * Uncomment this code below, and run the
 *
 * npm run run-service GetChatGPTFunction
 *
 * command to test this SDK method quickly and dirty ;-)
 *
 **
(async () => {
  await TestGetChatGPTFunction();
})();
*/
/**
 *
 ...
 * @returns
 */
export default function GetChatGPTFunction({ model_chosen, functionName, functionLanguage, functionPurpose, functionArgs, functionReturnValue, apiKey, progressIntervalMs, onJobCreated, onSuccess, onError, onProgress, print, jobId, }: {
    model_chosen?: string;
    functionName: string;
    ...
    onProgress?: (progress: GetChatGPTFunctionStatus) => void;
...
//# sourceMappingURL=GetChatGPTFunction.d.ts.map