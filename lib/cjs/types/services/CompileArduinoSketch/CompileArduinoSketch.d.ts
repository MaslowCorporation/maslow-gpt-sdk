import { CompileArduinoSketchStatus } from "./pieces/CompileArduinoSketchStatus.js";
/**
 *
 ...
 * @returns
 */
export default function CompileArduinoSketch({ codeString, apiKey, progressIntervalMs, onJobCreated, onSuccess, onError, onProgress, print, jobId, }: {
    codeString: string;
    apiKey: string;
    progressIntervalMs: number;
    onProgress?: (progress: CompileArduinoSketchStatus) => void;
...
//# sourceMappingURL=CompileArduinoSketch.d.ts.map