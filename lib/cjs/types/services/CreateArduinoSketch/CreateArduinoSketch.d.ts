 ...
 * @returns
 */
export default function CreateArduinoSketch({ model_chosen, programDescription, apiKey, progressIntervalMs, onJobCreated, onSuccess, onError, onProgress, print, jobId, }: {
    model_chosen?: string;
...
//# sourceMappingURL=CreateArduinoSketch.d.ts.map